...
<?php 
  /* HEAD */
  $lang       = 'en';
  $head_title = 'Interview — Ryutaro Takahashi — Art Space Tokyo';
  $head_desc  = 'An interview with Ryutaro Takahashi';
  $fburl      = 'read.artspacetokyo.com/interviews/ryutaro-takahashi/';
  $fbimg      = '';
  
  /* MENU */
  $current_page = 'ryutaro-takahashi';
?>
      ...
      <div class="row">
        <div class="twelvecol">
          <div class="content_head">
            <h1>A Collection With a Personal Edge</h1>
            <h2 class="subtitle">An interview with Ryutaro Takahashi</h2>
            <h2 class="location">Takahashi Collection</h2>
          </div>          
        </div>
      </div>
      ...
      <div class="row">
        <div class="eightcol">
          ...
          <div class="interview_body">
            ...
            <p class="ast">What kind of collection are you trying to build?</p>
            <p class="other"><span>RT</span>I don’t have a general concept for my collection. Collections, especially private ones, evolve out of each collector’s tastes and interests. I want to create a collection that reveals my personal taste; I’m focusing on young Japanese artists who have a solid training in the technical side of art production and whose work is sincere. I don’t like works that are particularly minimalist or conceptual or those that depend on a lot of words to explain them.</p>
            
            <p class="ast">Is it important to you to develop relationships with the artists themselves?</p>
            <p class="other"><span>RT</span>For me, the artwork is everything. Let’s say an incredibly mean artist created something that spoke to me eloquently; well, that’s all I need. Although I want to be close to their work, I prefer not to become too friendly with the artists; it’s better to keep some distance.</p>

            <p class="ast">Do you generally buy from the primary or secondary market?</p>
            <p class="other"><span>RT</span>Mostly I buy from the primary market, very rarely the secondary. Japan doesn’t have an established secondary market, other than that of the auction houses. Lately, auctions have been flooded with not only Japanese money, but money from the rest of Asia, and the result has been a new bubble in the art market. Trying to develop a collection out of the works available at auctions would raise the cost exponentially, so I avoid it. The exception, of course, is if I see something unusually cheap on the secondary market.</p>
            
            <p class="ast">What do you think makes a good collection?</p>
            <p class="other"><span>RT</span>In my view, a collection gains meaning when it has a personal edge to it. I don’t think you can collect an attractive body of work when multiple people are involved. This is the problem with public and corporate collections: you’ll have ten or so curators discuss which works to procure this year to satisfy very broad demands.</p>
            <p class="other">When you look at foundations in Japan, even when you have a private collector inheriting the foundation, his or her personal selections become a public affair. The foundation ends up involving the input of a curator, a city representative, then the family relatives and so on. By the time the second or third generation takes over the foundation, too many people have become involved and the collection will have lost much of the character it had at the beginning. A good collection is one in which collectors have made their own additions with each generation and yet it still maintains the freshness and edge it had during the first generation.</p>

            <p class="ast">What do you look for in an artwork?</p>
            <p class="other"><span>RT</span>I want artworks that grab hold of me at the moment I see them and draw me in. I don’t look at them in terms of their financial value or their potential to stand the test of time. In terms of media, I tend to prefer two-dimensional works, as it simplifies the problem of display and storage. Paintings and drawings are also easier to evaluate from an amateur’s point of view. For instance, I find it hard to assess the worth of three-dimensional conceptual art and installation art; I have no education in that area, so I tend to gravitate toward more traditional formats. Gallery owners have been able to pick up on certain trends in my tastes: whenever they show me a work that they think will appeal to me, they have usually been right.</p>

            <p class="ast">Are your choices constrained by size?</p>
            <p class="other"><span>RT</span>Yes. I don’t want to collect big sculptures or installations that require lots of space. The biggest work I have is a twelve-meter-long painting by Satoko Nachi, but it’s divided into panels, so it’s not too difficult to store and display.</p>
            
            <p class="ast">Do you have a favorite piece in your collection?</p>
            <p class="other"><span>RT</span>It’s a dangerous one: Makoto Aida’s <em>Tsuki</em>, from the <em>Inu</em> series. I’ve always liked that piece. A woman’s hands and legs torn off and bandaged. That piece was rejected from the Ueno Royal Museum’s exhibition of Makoto Aida and Akira Yamaguchi’s work last year.<sup id="ref1"><a href="#fn1">1</a></sup></p>
            
            <p class="ast">What does that work say about Japan?</p>
            ...
            <p class="ast">How has contemporary art in Japan changed over the past fifteen years?</p>
            <p class="other"><span>RT</span>Fifteen years ago, museums had no money to collect and young artists had lost their energy, except for a few like <a href="/essays/tokyo-impresario/">Takashi Murakami</a>, Yasumasa Morimura and Hiroshi Sugimoto. With the emergence of young artists like Akira Yamaguchi, Makoto Aida, Motohiko Odani and Yasuyuki Nishio, it was as if a tiny patch of green had sprouted out of the desert. In recent years, young artists are cropping up in numbers that I can barely keep up with.</p>
            
            <p class="ast">Where do you think Japanese contemporary art will go from here?</p>
            <p class="other"><span>RT</span>Speaking in terms of quality versus cost, some Asian collectors have said that works by Japanese artists fetch a mere twenty-five percent of their true value, while Korean artists get fifty percent and Chinese artists are earning one hundred percent. Some Asian collectors are gathering a lot of information about Japanese artists and are furiously buying up Japanese works. I think that eventually the price of works by Chinese artists will decline, while works by Japanese artists are already on the rise. The talk is that in five or so years, the price-to-quality ratio for artwork in these three countries will equalize. At the very least, we can expect the work of young Japanese artists to grow in value for the next five years.</p>

            <p class="ast">What are your thoughts on the Chinese contemporary art scene?</p>
            <p class="other"><span>RT</span>No matter how you look at it, it seems that the Chinese contemporary art scene is going through a bubble. I think it will eventually decline. Money is pouring into their art scene from all directions. However, there are so few artists who can maintain such powerful appeal for very long. I can’t help but be reminded of the extremely unpleasant precedent set by Japan’s bubble economy. In time, the value of works by Chinese contemporary artists could even drop by half. It may be better for now to avoid buying their work.</p>

            <p class="ast">What led you to open your spaces in Kagurazaka and then Shirokane? What do you aim to achieve with these spaces?</p>
            <p class="other"><span>RT</span>I created Takahashi Collection as a viewing room, feeling a sense of duty to make my collection accessible to the public. Even by loaning my works to museums, I can only display one hundred or so a year. The remaining nine hundred would never get shown. It was while I was looking for a warehouse to store my collection that I came across the Kagurazaka space. I felt it was too nice to be used merely for storage, so I decided to hook up with new gallery owners Kimiyoshi Kodama and Yuko Yamamoto and make a go of it. The Kagurazaka space is a regular viewing room for group exhibitions, whereas exhibitions at the new Shirokane space will be executed by the artist as installations incorporating previously shown pieces, perhaps even featuring a new one too.</p>

            <p class="ast">Do you find yourself buying in different frames of mind, sometimes for yourself and sometimes for the broader benefit of the Takahashi Collection?</p>
            <p class="other"><span>RT</span>Putting my collection on public display has introduced that element. Occasionally I find myself wondering if I should acquire such-and-such a work to balance the overall scope of my collection, but I don’t want to veer in that direction. My personal tastes and interests always take precedence over creating a sense of balance in the collection.</p>
            
            <p class="ast">What is the future of your collection?</p>
            <p class="other"><span>RT</span>From August 2008, it will make two rounds over the next two years through three museums: Kirishima Open-Air Museum in Kagoshima Prefecture, the Hokkaido no Mori Museum in Hokkaido and the Ueno Royal Museum in Tokyo. Beyond that, at some point I want to open a museum for the collection.</p>

            <div class="footnotes">
              <h4>Noted</h4>
            	<ol>
            		<li id="fn1">Held from May 20 to June 19, 2007.<a href="#ref1">↩</a></li>
            	</ol>
            
              <h4 style="margin-top: 30px;">Update</h4>
              <p><em>In April 2009, Takahashi closed his spaces in Kagurazaka and Shirokane, and reopened them as a single, larger space at street level in Hibiya.</em></p>
            </div>
          </div>
        </div>
